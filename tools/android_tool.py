...
Tools registered:
  ...
  - android_noise_watch_start enable the visible loud-noise camera watcher
  - android_noise_watch_stop  stop the loud-noise camera watcher
  - android_noise_watch_status inspect watcher state and newest clip
  - android_noise_video_fetch stream a recorded camera clip to a local MEDIA file
